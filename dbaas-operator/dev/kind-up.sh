...
# ── 6. Test resources ─────────────────────────────────────────────────────────
info "Applying test resources (namespace test-ns, Secret RBAC, secret)..."
...
# business namespace must grant it via a Role + RoleBinding. Managed CRs select this
# operator with spec.operatorNamespace=dbaas-system.
