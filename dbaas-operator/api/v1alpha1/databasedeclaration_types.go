...
type DatabaseDeclarationSpec struct {
	...
	// foo is an example field of DatabaseDeclaration. Edit databasedeclaration_types.go to remove/update
	// +optional
...
type DatabaseDeclarationStatus struct {
	...
	// conditions represent the current state of the DatabaseDeclaration resource.
