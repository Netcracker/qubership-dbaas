...
@Provider
public class NotSupportedServiceRoleExceptionMapper implements ExceptionMapper<NotSupportedServiceRoleException> {

    @Context
    UriInfo uriInfo;

    @Override
    public Response toResponse(NotSupportedServiceRoleException e) {
