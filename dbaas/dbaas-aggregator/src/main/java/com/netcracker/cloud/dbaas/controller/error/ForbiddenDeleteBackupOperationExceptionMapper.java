...
@Provider
public class ForbiddenDeleteBackupOperationExceptionMapper implements ExceptionMapper<ForbiddenDeleteBackupOperationException> {

    @Context
    UriInfo uriInfo;

    @Override
    public Response toResponse(ForbiddenDeleteBackupOperationException e) {
