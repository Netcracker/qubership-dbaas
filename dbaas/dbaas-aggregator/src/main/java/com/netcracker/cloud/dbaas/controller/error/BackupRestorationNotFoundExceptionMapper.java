...
@Provider
public class BackupRestorationNotFoundExceptionMapper implements ExceptionMapper<BackupRestorationNotFoundException> {

    @Context
    UriInfo uriInfo;

    @Override
    public Response toResponse(BackupRestorationNotFoundException e) {
