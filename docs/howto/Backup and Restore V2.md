...
**Steps 13,21,25:**: Step aggregates overall restore status and metrics: collects LogicalRestore statuses, counts total and completed restore databases, gathers/logs error messages, then sets restore.status, total, completed, and errorMessage (and logs the aggregated result)
...
**Step 10:** Step aggregates overall restore status and metrics: collects LogicalRestore statuses, counts total and completed restore databases, gathers/logs error messages, then sets restore.status, total, completed, and errorMessage.
...
**Step 9:** Step aggregates overall restore status and metrics: collects LogicalRestore statuses, counts total and completed restore databases, gathers/logs error messages, then sets restore.status, total, completed, and errorMessage.
