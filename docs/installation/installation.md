...
| [DBAAS_BACKUP_RESTORE_CHECK_INTERVAL](./parameters.md#dbaas_backup_restore_check_interval)                                                | Specifies the period of backup or restore check                                                                                                                                                                                                                                                     |                                                                                 |
...
| [DBAAS_BACKUP_RESTORE_RETRY_DELAY_SECONDS](./parameters.md#dbaas_backup_restore_retry_delay_seconds)                                      | Specifies the delay between retries in seconds                                                                                                                                                                                                                                                      |                                                                                 |
