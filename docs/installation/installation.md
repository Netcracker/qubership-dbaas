...
| [DBAAS_BACKUP_RESTORE_RETRY_DELAY_SECONDS](./parameters.md#dbaas_backup_restore_retry_delay_seconds)                                      | Specifies the delay between retries of requesting adapter in seconds if the previous attempt failed.                                                                                                                                                                                                |                                                                                 |
...
| [KUBERNETES_M2M_ENABLED](./parameters.md#kubernetes_m2m_enabled)                                                                          | If KUBERNETES_M2M_ENABLED is set to true, dbaas-aggregator will accept requests with Kubernetes service account tokens for M2M authentication.                                                                                                                                                      | false                                                                           |
| [KUBERNETES_M2M_AUDIENCE](./parameters.md#kubernetes_m2m_audience)                                                                        | KUBERNETES_M2M_AUDIENCE specifies the expected audience from Kubernetes tokens. Tokens with a different audience are rejected.                                                                                                                                                                      | dbaas                                                                           |
