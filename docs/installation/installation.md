...
| [DBAAS_BACKUP_RESTORE_CHECK_INTERVAL](./parameters.md#dbaas_backup_restore_check_interval)                                                | Specifies the period requesting adapters for backup or restore during an asynchronous process                                                                                                                                                                                                       |                                                                                 |
| [DBAAS_BACKUP_RESTORE_CHECK_ATTEMPTS](./parameters.md#dbaas_backup_restore_check_attempts)                                                | Specifies the max number of attempts to requesting adapters for backup or restore during an asynchronous process                                                                                                                                                                                    |                                                                                 |
