...
| [DBAAS_BACKUP_RESTORE_CHECK_LOCK_TIMEOUT](./parameters.md#dbaas_backup_restore_check_lock_timeout)                                        | Specifies the amount of time the lock should be kept in case the executing node dies.                                                                                                                                                                                                               |                                                                                 |
...
| [DBAAS_BACKUP_RESTORE_RETRY_ATTEMPTS](./parameters.md#dbaas_backup_restore_retry_attempts)                                                | Specifies the max number of retries to request adapter for backup or restore if the previous attempt failed.                                                                                                                                                                                        |                                                                                 |
