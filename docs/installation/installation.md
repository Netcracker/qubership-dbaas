...
| [DBAAS_BACKUP_RESTORE_CHECK_LOCK_TIMEOUT](./parameters.md#dbaas_backup_restore_check_lock_timeout)                                        | Specifies the default amount of time the lock should be kept in case the executing node dies                                                                                                                                                                                                        |                                                                                 |
| [DBAAS_BACKUP_RESTORE_CHECK_INTERVAL](./parameters.md#dbaas_backup_restore_check_interval)                                                | Specifies the interval between requests to adapters for backup or restore status during an asynchronous process                                                                                                                                                                                     |                                                                                 |
| [DBAAS_BACKUP_RESTORE_CHECK_ATTEMPTS](./parameters.md#dbaas_backup_restore_check_attempts)                                                | Specifies the max number of attempts to request adapters for backup or restore status during an asynchronous process                                                                                                                                                                                |                                                                                 |
| [DBAAS_BACKUP_RESTORE_RETRY_DELAY_SECONDS](./parameters.md#dbaas_backup_restore_retry_delay_seconds)                                      | Specifies the delay between retries of requesting adapter in seconds if the previous attempt was failed                                                                                                                                                                                             |                                                                                 |
| [DBAAS_BACKUP_RESTORE_RETRY_ATTEMPTS](./parameters.md#dbaas_backup_restore_retry_attempts)                                                | Specifies max number of retries to requesting adapter for backup or restore if the previous attempt was failed                                                                                                                                                                                      |                                                                                 |
| [DBAAS_SECURITY_NAMESPACE_ISOLATION_ENABLED](./parameters.md#dbaas_security_namespace_isolation_enabled)                                  | If DBAAS_SECURITY_NAMESPACE_ISOLATION_ENABLED is set to true, dbaas-aggregator will reject requests with invalid namespace.                                                                                                                                                                         | true                                                                            |
| [KUBERNETES_JWT_ENABLED](./parameters.md#kubernetes_jwt_enabled)                                                                          | If KUBERNETES_JWT_ENABLED is set to true, dbaas-aggregator will accept requests with Kubernetes service account tokens for M2M authentication.                                                                                                                                                      | true                                                                            |
| [KUBERNETES_JWT_AUDIENCE](./parameters.md#kubernetes_jwt_audience)                                                                        | KUBERNETES_JWT_AUDIENCE specifies the expected audience from Kubernetes tokens. Tokens with a different audience are rejected.                                                                                                                                                                      | dbaas                                                                           |
